                    ...
                    <div class="card-body p-4">
                        ...
                        <form method="post" action="index.php?action=message" id="contactForm" data-sb-form-api-token="API_TOKEN">
                            ...
                            <div class="form-floating mb-3">
                                <input value="<?php if (isset($_GET['reply'])) echo htmlspecialchars($mail['sender']) ?>" name="recipient" class="form-control" id="recipient" type="text" placeholder="Recipient" data-sb-validations="required" />
                                <label for="recipient">Recipient</label>
                                <div class="invalid-feedback" data-sb-feedback="recipient:required">Recipient is required.</div>
                            </div>

                            <div class="form-floating mb-3">
                                <input value="<?php if (isset($_GET['reply'])) echo "RE:" . htmlspecialchars($mail['subject']) ?>" name="subject" class="form-control" id="subject" type="text" placeholder="Subject" data-sb-validations="required" />
